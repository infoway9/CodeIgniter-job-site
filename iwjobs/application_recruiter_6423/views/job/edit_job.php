...
<form name="jobeditpost_frm" id="jobeditpost_frm" action="" method="post" enctype="multipart/form-data" onsubmit="return validate_editjob();">
...
<div class="rigrow">
<div class="leftreg">Status <span>*</span>:</div>
<div class="countrybox">
    <input type="radio" name="status" id="status" value="A" onclick="radio_chk(this.value);" <?php if( isset ($status) && $status=='A') echo 'checked="checked"'; ?> />Active
    <input type="radio" name="status" id="status" value="I" onclick="radio_chk(this.value);" <?php if( isset ($status) && $status=='I') echo 'checked="checked"'; ?> />Inactive
</div>
...
<input name="btn_jobedit" id="jobedit_btn_container" type="submit" class="submitreg_btn" value="Edit Job" />
