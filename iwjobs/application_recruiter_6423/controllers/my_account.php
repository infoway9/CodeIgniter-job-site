...
class My_account extends CI_Controller {
    ...
    public function change_passowrd()
    {
        ...
        //--- start collecting values of input elements ---//
            ...
            if ($current_password != "") {
                $get_valid_oldpswd = $this->My_accountdb->matchwith_oldpassword($recruiter_id, $current_password);
            }
            ...
            //---- start changing password in database ----//
                ...
                $this->Userdb->update_recruiter_data($recruiter_id, $data);
                ...
                $user_name = $recruiter_email_detail['fullname'];
                $email = $recruiter_email_detail['email'];
    ...
    public function change_email()
    {
        ...
        //-------- assign initial values to the variables ------------//
            $recruiter_email_detail=$this->all_function->get_recruiter_emaildetail($recruiter_id);
            $data_msg['old_email']=$recruiter_email_detail['email'];
        ...
        //--- start collecting values of input elements ---//
            ...
            $current_email = $recruiter_email_detail['email'];
            ...
            //---- start changing email in database ----//
                ...
                //---- end changing email in database ----//
                
                //--- start loading recruiter model and fetch recruiter email ---//

                $recruiter_email_detail=$this->all_function->get_recruiter_emaildetail($recruiter_id);
                $user_name = $recruiter_email_detail['fullname'];
                $email = $recruiter_email_detail['email'];

                //--- end loading recruiter model and fetch recruiter email---//
